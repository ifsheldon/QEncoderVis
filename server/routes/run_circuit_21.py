...
def run_circuit_21(feature_map_name: str | None = None):
    ...
    if feature_map_name is None:
        fm = get_default_feature_map_for_circuit(21)
    else:
    ...
    result_to_return = {
        ...
        "encoded_steps": [
            ...
            {"feature": feature, "label": result["flag4"][0]},
        ],
        "encoded_steps_sub": [
            [
            ...
            [
                {"feature": feature, "label": result["flag4"][1]},
                {"feature": feature, "label": result["flag4"][2]},
            ],
        ],
