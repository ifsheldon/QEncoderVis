...
def run_datadet_0():
    ...
    def encoded_map_cal(flag_name="encoded"):
        # extract and draw the encoded data
        target_probs_list = []

        for i, data_point in enumerate(features):
            encoded = qml.snapshots(circuit)(weights, data_point)[flag_name]
        ...
        result = [expval, prob_measure_q0_1, prob_measure_q0_0]
    ...
    return {
        ...
        "encoded_data": {"feature": feature, "label": encoded_map_cal("encoded")[0]},
        ...
        "encoded_steps": [
            {"feature": feature, "label": encoded_map_cal("flag1")[0]},
            {"feature": feature, "label": encoded_map_cal("flag2")[0]},
            {"feature": feature, "label": encoded_map_cal("flag3")[0]},
        ],
        "encoded_steps_sub": [
            [
                {"feature": feature, "label": encoded_map_cal("flag1")[1]},
                {"feature": feature, "label": encoded_map_cal("flag1")[2]},
            ],
            [
                {"feature": feature, "label": encoded_map_cal("flag2")[1]},
                {"feature": feature, "label": encoded_map_cal("flag2")[2]},
            ],
            [
                {"feature": feature, "label": encoded_map_cal("flag3")[1]},
                {"feature": feature, "label": encoded_map_cal("flag3")[2]},
            ],
        ],
    }
