...
def draw_cost_and_acc_plot(epoch_number, cost_list, acc_val_list):
    epochs = range(1, epoch_number+1)  # assuming acc_train and acc_val are lists containing the accuracy per epoch
    ...
    ax2.plot(epochs, acc_val_list, color='red', marker='o', linestyle='-', linewidth=2, markersize=5)
