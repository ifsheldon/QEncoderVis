		...
		if (isLegend) {
			...
			if (isContinuous) {
				const legend = g
					...
					.attr(
						"transform",
						`translate(${axis_size + g_paddingLeft + axis_length - legend_width}, ${axis_length + axis_size + g_paddingTop})`,
					);
			...
			//     如果value是从-1到1的连续的值
				...
				const legend = g
					...
					.attr(
						"transform",
						`translate(${axis_size + g_paddingLeft + axis_length - legend_width * 1.4}, ${axis_length + axis_size + g_paddingTop - 5})`,
					);
